...
for (let index = 1; index <= n; index += 1) {
  for (let secondaryIndex = 1; secondaryIndex <= n; secondaryIndex += 1) {
    line += aster;
    if (secondaryIndex == n) line += breakline;
  }
}
...
if (n % 2 != 0) {
  for (let index = 0; index < middleCeil; index += 1) {
    for (let secondaryIndex = n; secondaryIndex >= 0; secondaryIndex -= 1) {
      if (
        secondaryIndex == middleFloor ||
        (secondaryIndex <= middleFloor + lineCounter &&
          secondaryIndex >= middleFloor - lineCounter)
      )
        line += aster;
      else line += space;
  ...
  for (let index = 0; index < middleFloor; index += 1) {
    for (let secondaryIndex = n; secondaryIndex >= 0; secondaryIndex -= 1) {
      if (
        secondaryIndex == middleFloor ||
        secondaryIndex == middleCeil ||
        (secondaryIndex <= middleCeil + lineCounter &&
          secondaryIndex >= middleFloor - lineCounter)
      )
        line += aster;
      else line += space;
